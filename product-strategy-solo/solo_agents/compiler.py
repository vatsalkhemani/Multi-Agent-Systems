...
You will receive the complete output from all agents: research, synthesis, strategy, and GTM plan. Your job is to produce a polished, comprehensive Markdown document.
